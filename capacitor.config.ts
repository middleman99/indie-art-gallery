...
const config: CapacitorConfig = {
  ...
  plugins: {
    ...
    // Style 'LIGHT' = dark icons - correct now that the app (and its
    // header/footer) are back to a light cream theme, matching the splash
    // screen's cream background below.
    StatusBar: {
