      ...
      <div className="container" style={{ paddingTop: 'var(--sp-4)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 'var(--sp-3)', marginBottom: 'var(--sp-6)' }}>
          {STATS_DISPLAY.map(({ label, value, icon: Icon, color }) => (
            <div key={label} style={{ padding: 'var(--sp-4)', background: 'rgba(21,23,26,0.04)', borderRadius: 'var(--r-md)', border: '1px solid rgba(21,23,26,0.08)' }}>
        ...
        {tab === 'overview' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-4)' }}>
            <div style={{ padding: 'var(--sp-5)', background: 'rgba(21,23,26,0.04)', borderRadius: 'var(--r-md)', border: '1px solid rgba(21,23,26,0.08)' }}>
        ...
        {tab === 'users' && (
          <div>
            {usersLoading ? (
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-2)' }}>
                {users.map(u => (
                  <div key={u.id} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: 'var(--sp-3)', background: 'rgba(21,23,26,0.04)', borderRadius: 'var(--r-md)', border: '1px solid rgba(21,23,26,0.08)' }}>
                    <div>
        ...
        {tab === 'listings' && (
          <div>
            {listingsLoading ? (
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-2)' }}>
                {listings.map(l => (
                  <div key={l.id} style={{ display: 'flex', justifyContent: 'space-between', padding: 'var(--sp-3)', background: 'rgba(21,23,26,0.04)', borderRadius: 'var(--r-md)', border: '1px solid rgba(21,23,26,0.08)' }}>
                    <div>
        ...
        {tab === 'payouts' && (
          <div>
            {payoutsLoading ? (
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-2)' }}>
                {payoutOrders.map(o => (
                  <div key={o.id} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: 'var(--sp-3)', background: 'rgba(21,23,26,0.04)', borderRadius: 'var(--r-md)', border: '1px solid rgba(21,23,26,0.08)' }}>
                    <div>
