      ...
      <div className="container" style={{ paddingTop: 'var(--sp-6)' }}>
        ...
        {loading ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-4)' }}>
            {orders.map(order => (
              <div key={order.id} style={{ display: 'flex', gap: 'var(--sp-4)', padding: 'var(--sp-4)', background: 'rgba(255,255,255,0.04)', borderRadius: 'var(--r-lg)', border: '1px solid rgba(255,255,255,0.08)' }}>
