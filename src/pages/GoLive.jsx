        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-4)' }}>
          ...
          {form.allowBidding && (
            <div>
              ...
              {myListings.length === 0 ? (
                <div style={{ padding: 'var(--sp-6)', textAlign: 'center', color: 'var(--slate)', background: 'rgba(21,23,26,0.04)', borderRadius: 'var(--r-md)' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-2)' }}>
                  {myListings.map(p => (
                    <div
                      ...
                      style={{
                        padding: 'var(--sp-3)',
                        border: `2px solid ${selectedPiece?.id === p.id ? 'var(--coral)' : 'rgba(21,23,26,0.1)'}`,
