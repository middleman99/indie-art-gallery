          ...
          <div>
            ...
            {imagePreview ? (
              <div style={{ position: 'relative' }}>
                <img src={imagePreview} alt="Preview" style={{ width: '100%', maxHeight: 320, objectFit: 'contain', borderRadius: 'var(--r-md)', background: 'rgba(21,23,26,0.04)' }} />
              ...
              <div
                ...
                style={{ border: '2px dashed rgba(21,23,26,0.15)', borderRadius: 'var(--r-md)', padding: 'var(--sp-10)', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--sp-3)', cursor: 'pointer', transition: 'border-color var(--t-fast)' }}
                onMouseEnter={e => e.currentTarget.style.borderColor = 'var(--coral)'}
                onMouseLeave={e => e.currentTarget.style.borderColor = 'rgba(21,23,26,0.15)'}
              >
          ...
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--sp-3)' }}>
              {[
                ...
                <div key={value} onClick={() => set('listingType', value)} style={{ padding: 'var(--sp-4)', border: `2px solid ${form.listingType === value ? 'var(--coral)' : 'rgba(21,23,26,0.1)'}`, borderRadius: 'var(--r-md)', cursor: 'pointer', background: form.listingType === value ? 'var(--coral-soft)' : 'transparent', transition: 'all var(--t-fast)', display: 'flex', flexDirection: 'column', gap: 4 }}>
