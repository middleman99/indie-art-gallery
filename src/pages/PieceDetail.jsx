  ...
  return (
    <div className="page">
      ...
      <div className="container" style={{ paddingTop: 'var(--sp-4)', maxWidth: 600 }}>
        ...
        {piece.provenance && (
          <div style={{ padding: 'var(--sp-4)', background: 'rgba(28,26,23,0.03)', borderRadius: 'var(--r-md)', border: '1px solid rgba(28,26,23,0.06)', marginBottom: 'var(--sp-5)' }}>
        ...
        <div style={{ marginBottom: 'var(--sp-5)' }}>
          {piece.listingType === 'fixed' ? (
            <div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: 'var(--sp-3)', borderTop: '1px solid rgba(28,26,23,0.08)' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: 'var(--sp-3)', borderTop: '1px solid rgba(28,26,23,0.08)', marginBottom: 'var(--sp-4)' }}>
        ...
        {piece.deliveryType === 'physical' && (
          <div style={{ padding: 'var(--sp-3)', background: 'rgba(28,26,23,0.04)', borderRadius: 'var(--r-md)', marginBottom: 'var(--sp-4)', fontSize: 'var(--text-xs)', color: 'var(--slate)', display: 'flex', alignItems: 'flex-start', gap: 'var(--sp-3)' }}>
        ...
        {showOffer && (
          <div style={{ marginTop: 'var(--sp-4)', padding: 'var(--sp-4)', background: 'rgba(28,26,23,0.04)', borderRadius: 'var(--r-md)', border: '1px solid rgba(28,26,23,0.08)' }}>
