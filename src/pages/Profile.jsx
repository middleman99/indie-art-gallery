...
function OnboardingChecklist({ profile, user, navigate, onEditProfile }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ height: 4, background: 'rgba(21,23,26,0.08)', borderRadius: 999, marginBottom: 'var(--sp-4)', overflow: 'hidden' }}>
        <div style={{
          height: '100%',
  ...
  return (
    <div style={{ marginBottom: 'var(--sp-6)' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-3)' }}>
        {offers.map(offer => (
          <div key={offer.id} style={{ padding: 'var(--sp-4)', background: 'rgba(21,23,26,0.04)', borderRadius: 'var(--r-md)', border: '1px solid rgba(21,23,26,0.08)' }}>
  ...
  return (
    <div className="page" style={{ paddingTop: 'var(--sp-6)' }}>
      <div className="container">
        ...
        <div style={{ display: 'flex', gap: 'var(--sp-4)', paddingBottom: 'var(--sp-4)', borderBottom: '1px solid rgba(21,23,26,0.08)', marginBottom: 'var(--sp-4)' }}>
        ...
        {editing && (
          <div style={{ marginBottom: 'var(--sp-6)', padding: 'var(--sp-5)', background: 'rgba(21,23,26,0.04)', borderRadius: 'var(--r-lg)', border: '1px solid rgba(21,23,26,0.08)' }}>
