...
function Chat({ showId, user, profile }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <form onSubmit={sendMessage} style={{ padding: 'var(--sp-3)', borderTop: '1px solid rgba(28,26,23,0.08)', display: 'flex', gap: 'var(--sp-2)' }}>
        <input
          className="input"
          type="text"
      ...
      <div className="sheet" onClick={e => e.stopPropagation()}>
        ...
        {shows.length === 0 ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-3)' }}>
            {shows.map(s => (
              <div key={s.id} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: 'var(--sp-4)', background: 'rgba(28,26,23,0.04)', borderRadius: 'var(--r-md)', border: '1px solid rgba(28,26,23,0.08)' }}>
                <div>
...
export default function ShowRoom() {
  ...
  return (
    <div style={{ height: '100dvh', display: 'flex', flexDirection: 'column', background: 'var(--charcoal)' }}>
      ...
      <div style={{ padding: 'var(--sp-3) var(--sp-4)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid rgba(28,26,23,0.08)', flexShrink: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--sp-3)' }}>
      ...
      <div style={{ display: 'flex', borderBottom: '1px solid rgba(28,26,23,0.08)', flexShrink: 0 }}>
      ...
      {isHost && (
        <div style={{ padding: 'var(--sp-3)', borderTop: '1px solid rgba(28,26,23,0.08)', display: 'flex', gap: 'var(--sp-3)', flexShrink: 0 }}>
